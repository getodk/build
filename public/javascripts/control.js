...
; (function ($) {
    ...
    kor.events.listen({
        verb: 'control-selected', callback: function (event) {
    ...
    kor.events.listen({
        verb: 'control-deselected', callback: function (event) {
    ...
    $.fn.odkControl.defaultProperties = {
        ...
        constraint: {
            ...
            tips: [
                'The <a href="https://getodk.github.io/xforms-spec/#xpath-functions" rel="external">ODK XForms Functions Spec</a> may be useful.',
        ...
        bigimage: {
            name: 'Clickable Image Label (filename)',
            type: 'uiText',
            description: 'Media labels can be used in addition to text labels or instead of text labels.',
    ...
    $.fn.odkControl.controlProperties = {
        ...
        inputNumeric: {
            ...
            selectStep: {
                name: 'Selectable Range: Step Between Choices',
                type: 'text',
        ...
        metadata: {
            ...
            kind: {
                ...
                options: ['Device ID', 'Start Time', 'End Time', 'Today', 'Username', 'Email', 'Subscriber ID',
                    'SIM Serial', 'Phone Number', 'Start Geopoint', 'Audit'],
                value: 'Device ID',
                summary: true
            },
            location_priority: {
